...
DEFAULTS: dict[str, Any] = {
    ...
    # [index_0, index_1, middle_0, middle_1, thumb_0, thumb_1, thumb_2] — iter10 values that
    # held+lifted the cube; firmer (iter11) over-squeezed and ejected it. Carry slowly instead.
    "hand_close_vals": [1.2, 1.5, 1.2, 1.5, 0.9, 1.0, 0.6],
